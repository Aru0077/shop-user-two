        ...
        <div class="flex-1 flex items-center justify-center p-6">
            <div class="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-500 to-indigo-600 p-8 text-white">
                    ...
                    <p class="mt-2 text-blue-100">请登录您的账号以继续</p>
                </div>
                ...
                <div class="p-8">
                    <form @submit.prevent="handleLogin" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="username" v-model="username" type="text" required
                                    ...
                                    placeholder="输入您的用户名" :disabled="isLoading" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="password" v-model="password" :type="showPassword ? 'text' : 'password'"
                                    ...
                                    placeholder="输入您的密码" :disabled="isLoading" />
                        ...
                        <!-- 登录按钮 -->
                        <button type="submit"
                            class="w-full py-3 px-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex items-center justify-center"
